...
public class LeskGlossOverlaps
{
	...
	private boolean uselemmatiser	=	false;	// default: 'on'
	...
	public double overlap(String x, String y)
	{
		...
		// 3. if there are no overlaps then return 0
		if(xy.isEmpty())
			return ( 0.0 );

		// 4. build usable, non 'tied into Lists' lists
		...
		// 6. check that an overlap does have at least 1 content word
